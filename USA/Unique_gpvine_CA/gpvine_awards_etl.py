...
logging.basicConfig(level=logging.INFO,
    ...
    handlers=[logging.FileHandler("txsmartbuy_ETL.log"),
...
class TenderETL:
    ...
    def __init__(self,
        source_collection: str = "gpvine_awarded_tenders",
        source_website: str = "https://gpvine.ionwave.net/Login.aspx",
        ...
        logger.info(" GPVINE CA ETL Initialized Successfully")
    ...
    def safe_float(self, value):
        try:
            ...
            return None
    def get_awarded_vendors(self, raw_data):
        return raw_data.get("awarded_vendors", [])

    def get_vendor_name(self, raw_data, index=0):
        vendors = raw_data.get("awarded_vendors", [])
        if len(vendors) > index:
            return vendors[index].get("vendor_name")
        return None

    def get_vendor_amount(self, raw_data, index=0):
        vendors = raw_data.get("awarded_vendors", [])
        if len(vendors) > index:
            return vendors[index].get("amount")
        return None   
    ...
    def transform(self, raw_data):
        ...
        return {
            ...
            "tender_number":raw_data.get("bid_number"),
            "tender_id":None,
            "tender_ra_number":None,

            "tender_title":raw_data.get("title"),
            "tender_description":raw_data.get("description"),
            ...
            "tender_state":None,
            "tender_pincode":None,
            "tender_country":"UNITED STATES",

            "tender_organisation":None,
            "tender_financier":"Self Financier",
            "tender_item_quantity":None,
            "tender_purchaser_ownership":"Public",
            "tender_value":raw_data.get("total_award_amount_raw"),
            "tender_emd":None,
            "tender_document_fees":None,
            "tender_purchaser_address":raw_data.get("contact_info"),

            "tender_start_date":self.parse_date(raw_data.get("award_date")),
            "tender_end_date":None,
            "tender_publishing_date":self.parse_date(raw_data.get("award_date")),
            ...
            "bid_awarded_result": {
                "bid_details": {
                    ...
                    "quantity":None,
                    "validity":None,
                    "start_date":self.parse_date(raw_data.get("award_date")),
                    "end_date":None,
                    "opening_date":self.parse_date(raw_data.get("award_date")),
                    "buyer_name":raw_data.get("vendor_name"),
                    "buyer_address":raw_data.get("vendor_name"),
                    "ministry":None,
                    "department":None,
                    "organisation":None,
                    "office":None
            ...
            "technical_evaluation": [
                {
                    "serial_no": 1,
                    "seller_name": self.get_vendor_name(raw_data, 0),
                    "offered_item":None,
                 ...
                 {
                    "serial_no": 2,
                    "seller_name": self.get_vendor_name(raw_data, 1),
                    "offered_item":None,
                    "participated_on": None,
                    "status": "Awarded",
                    "emd_status": None,
                ...
                [
                    {
                        ...
                        "offered_item": None,
                        "participated_on": None,
                        "total_price": self.get_vendor_amount(raw_data, 0),
                        "rank": "L1",
                        "is_winner": "winner",
                        "status": "L1",
                        "currency": "USD",
                    ...
                    
                    {
                        ...
                        "offered_item": None,
                        "participated_on": None,
                       "total_price": self.get_vendor_amount(raw_data, 1),
                        "rank": "L2",
                        "is_winner": "winner",
                        "status": "L2",
                        "currency": "USD",
            ...
            "llm_extracted_data": {
                ...
                "organization": {
                    "ministry": None,
                    "department": None,
                    "organisation_name":raw_data.get("vendor_name"),
                    "office_name": None
                },
    ...
    def run(self):
        raw_collection = self.db["gpvine_awarded_tenders"]
