...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("ocp_tender_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity="Office of Contracting and Procurement (OCP)",
                 source_website="https://contracts.ocp.dc.gov/",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "dc_ocp_awards",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_description": source_doc.get("synopsis"),
            ...
            "tender_pincode": None,
            "tender_purchaser_address": source_doc.get("worksite_location"),
            "tender_start_date": self.parse_date(source_doc.get("open_date")),
            "tender_end_date": self.parse_date(source_doc.get("closing_date")),
            "tender_publishing_date": self.parse_date(source_doc.get("open_date")),
            "tender_organisation": "Office of Contracting and Procurement (OCP)",
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        return {
            "basic_info": {
                ...
                "summary": source_doc.get("synopsis"),
                "tender_type": "OPEN",
                "main_category": None,
                "sub_category": None,
                "total_quantity": None,
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name": "Office of Contracting and Procurement (OCP)",
                "office_name": None
            },
            "timeline": {
