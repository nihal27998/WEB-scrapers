...
class ETL:
    def __init__(self,
                 tender_issuing_entity = "Los Angeles County",
                 source_website= "https://doingbusiness.lacounty.gov/solicitation-search/?type=solMainSearch&val=",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "lacounty_ca_tenders",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_pincode": None,
            "tender_purchaser_address":source_doc.get("contact_info"),  
            ...
            "tender_organisation": "Los Angeles County",
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name": "Los Angeles County",
                "office_name": None
            },
            "timeline": {
