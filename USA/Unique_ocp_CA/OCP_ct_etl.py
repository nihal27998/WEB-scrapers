...
class TenderETL:
    ...
    def __init__(self,
        source_collection: str = "dc_ocp_awards",
        source_website: str = "https://contracts.ocp.dc.gov/contracts/results?hash=q3l9gn99wm8y23fb",
        ...
        logger.info(" DCOCP CA ETL Initialized Successfully")
    ...
    def transform(self, raw_data):
        ...
        return {
            ...
            "tender_number":raw_data.get("contract_number"),
            "tender_id":None,
            ...
            "tender_organisation":raw_data.get("agency_names"),
            "tender_financier":"Self Financier",
            "tender_item_quantity":None,
            "tender_purchaser_ownership":"Public",
            "tender_value":raw_data.get("contract_amount_original"),
            "tender_emd":None,
            "tender_document_fees":None,
            "tender_purchaser_address":raw_data.get("contracting_officer"),

            "tender_start_date":self.parse_date(raw_data.get("award_date_raw")),
            "tender_end_date":None,
            "tender_publishing_date":self.parse_date(raw_data.get("award_date_raw")),
            ...
            "bid_awarded_result": {
                "bid_details": {
                    "bid_number":raw_data.get("contract_number"),
                    "status":"AWARDED",
                    "quantity":None,
                    "validity":None,
                    "start_date":self.parse_date(raw_data.get("award_date_raw")),
                    "end_date":None,
                    "opening_date":self.parse_date(raw_data.get("award_date_raw")),
                    "buyer_name":raw_data.get("agency_names"),
                    "buyer_address":raw_data.get("contracting_officer"),
                    "ministry":None,
                    "department":None,
                    "organisation":None,
                    "office":None
            ...
            "financial_evaluation": 
                [
                    {
                        "serial_no": 1,
                        "seller_name": raw_data.get("vendor"),
                        "offered_item": None,
                        "participated_on": None,
                        "total_price": raw_data.get("contract_amount_original"),
                        "rank": "L1",
                        "is_winner": "winner",
                        "status": "L1",
                        "currency": "USD",
            ...
            "llm_extracted_data": {
                ...
                "organization": {
                    "ministry": None,
                    "department": None,
                    "organisation_name":raw_data.get("agency_names"),
                    "office_name": None
                },
                ...
                "financial": {
                    "estimated_bid_value": {
                        "amount": raw_data.get("contract_amount_original"),
                        "currency": "USD",
                        "raw_text": None
                    },
                    "emd_details": [
    ...
    def run(self):
        raw_collection = self.db["dc_ocp_awards"]
