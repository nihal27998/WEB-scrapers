...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("Gpvine_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity = "City of Grapevine",
                 source_website= "https://gpvine.ionwave.net/Login.aspx",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "gpvine_tenders",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_type": source_doc.get("status_bucket"),
            ...
            "tender_organisation": "City of Grapevine",
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name": "City of Grapevine",
                "office_name": None
            },
            "timeline": {
