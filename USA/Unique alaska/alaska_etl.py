...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("Aws_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity = "STATE OF ALASKA",
                 source_website= "https://aws.state.ak.us/OnlinePublicNotices/Notices/Search.aspx",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "alaska_opn_tenders",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_number": source_doc.get("project_number"),  
            "tender_id": None,
            "tender_ra_number": None,
            "tender_title":   subject.lower().capitalize(),
            "tender_description": source_doc.get("title"),
            ...
            "tender_pincode": None,
            "tender_purchaser_address": "STATE OF ALASKA5000 W. International Airport Rd, Anchorage, AK 99502",

            "tender_start_date": self.parse_date(source_doc.get("posted_date_raw")),
            "tender_end_date": self.parse_date(source_doc.get("expires_date_raw")),
            "tender_publishing_date": self.parse_date(source_doc.get("posted_date_raw")),

            "tender_organisation": "STATE OF ALASKA",
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name": "STATE OF ALASKA",
                "office_name": None
            },
            "timeline": {
                "bid_end_datetime": self.parse_date(source_doc.get("expires_date_raw")),
                "bid_open_datetime": self.parse_date(source_doc.get("expires_date_raw")),
