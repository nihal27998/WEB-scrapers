...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("Montgomery_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity = "MONTGOMERY COUNTY MARYLAND",
                 source_website= "https://www.montgomerycountymd.gov/office-procurement/solicitations-contracts/formal-solicitations",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "montgomery_county_md_tenders",
    ...
    + (
        "\nEmail:\n"
        + "\n".join(source_doc.get("contact_emails", [])) if source_doc.get("contact_emails")
        else "")),

            "tender_start_date": self.parse_date(source_doc.get("publication_date")),
            "tender_end_date": self.parse_date(source_doc.get("bid_closing_raw")),
            "tender_publishing_date":self.parse_date(source_doc.get("publication_date")),                                                  \

            "tender_organisation": "MONTGOMERY COUNTY MARYLAND",
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        ...
        category_doc = {
            "title": source_doc.get("tender_subject"),
            "description": source_doc.get("scope_summary")
        }
        ...
        return {
            "basic_info": {
                "generated_title": source_doc.get("tender_subject"),
                "summary": source_doc.get("scope_summary"),
                "tender_type": "OPEN",
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name": "MONTGOMERY COUNTY MARYLAND",
                "office_name": None
            },
            "timeline": {
