...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("Tarrant_County_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity = "Tarrant County Texas",
                 source_website= "https://tarrantcountytx.ionwave.net/",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "tarrant_county_tenders",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_organisation": "Tarrant County Texas",
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name": "Tarrant County Texas",
                "office_name": None
            },
            "timeline": {
