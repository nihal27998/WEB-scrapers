...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("Galveston_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity = "CITY OF GALVESTON, TEXAS",
                 source_website= "https://www.galvestontx.gov/Bids.aspx?CatID=showStatus&txtSort=Category&showAllBids=on&Status=open",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "galveston_city_tenders",
    ...
    def parse_date(self, val):
        ...
        try:
            ...
            return None
    def get_purchaser_address(self, source_doc: Dict) -> Any:
        
        submittal_info = (source_doc.get("submittal_info") or "").strip()
        contact = (source_doc.get("contact") or "").strip()
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_description": source_doc.get("description","title"),
            ...
            "tender_pincode": None,
            "tender_purchaser_address":"823 Rosenberg St (25th St), Galveston, TX 77550", 

            "tender_start_date": self.parse_date(source_doc.get("pub_date_raw")),
            "tender_end_date": self.parse_date(source_doc.get("closing_raw")),
            "tender_publishing_date": self.parse_date(source_doc.get("pub_date_raw")),

            "tender_organisation": "CITY OF GALVESTON TEXAS",
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name": "CITY OF GALVESTON TEXAS",
                "office_name": None
            },
            "timeline": {
                "bid_end_datetime":  self.parse_date(source_doc.get("closing_raw")),
                "bid_open_datetime": self.parse_date(source_doc.get("closing_raw")),
