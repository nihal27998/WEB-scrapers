...
class ETL:
    def __init__(self,
                 tender_issuing_entity = "Mansfield Independent School District (MISD)",
                 source_website= "https://misd.ionwave.net/Login.aspx",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "mansfield_isd_tenders",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_start_date": self.parse_date(source_doc.get("issue_datetime")),
            "tender_end_date": self.parse_date(source_doc.get("close_datetime")),
            "tender_publishing_date": self.parse_date(source_doc.get("issue_datetime")),

            "tender_organisation": "Mansfield Independent School District (MISD)",
            ...
            "source_tag": "Mansfield-Independent-School-District",
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name": "Mansfield Independent School District (MISD) ",
                "office_name": None
            },
            "timeline": {
                "bid_end_datetime":  self.parse_date(source_doc.get("close_datetime")),
                "bid_open_datetime": self.parse_date(source_doc.get("close_datetime")),
