...
class TenderETL:
    ...
    def __init__(self,
        source_collection: str = "allegany_county_awards",
        source_website: str = "https://www.alleganygov.org/",
        ...
        logger.info(" ALLEGANY CA ETL Initialized Successfully")
        ...
        return {
            ...
            "bid_awarded_result": {
                "bid_details": {
                    ...
                    "buyer_name":raw_data.get("contact"),
                    "buyer_address":raw_data.get("contact"),
                    "ministry":None,
                    "department":None,
                    "organisation":None,
                    "office":None
    ...
    def run(self):
        raw_collection = self.db["allegany_county_awards"]
