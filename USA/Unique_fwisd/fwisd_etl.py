...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("Fwisd_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity = "FORT WORTH INDEPENDENT SCHOOL DISTRICT (FWISD)",
                 source_website= "https://fwisd.ionwave.net/",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "fwisd_tenders",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_organisation": "FORT WORTH INDEPENDENT SCHOOL DISTRICT (FWISD)",
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name": "FORT WORTH INDEPENDENT SCHOOL DISTRICT (FWISD)",
                "office_name": None
            },
            "timeline": {
