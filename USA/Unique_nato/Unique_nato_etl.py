...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("nspa_tender_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity="NATO Support and Procurement Agency (NSPA)",
                 source_website="https://eportal.nspa.nato.int/eProcurement5G/Opportunities/OpportunitiesList",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "nspa_nato_tenders",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_number": source_doc.get("reference"),
            "tender_id": None,
            ...
            "tender_pincode": None,
            "tender_purchaser_address": ("Rue de la Gare 11, L-8325 Capellen, G.-D. LuxembourgTel +35230636559, Mobile +352 661 669 376. Email alistair.birrell@nspa.nato.int."),
            "tender_start_date": self.parse_date(source_doc.get("publication_date")),
            "tender_end_date": self.parse_date(source_doc.get("closing_date")),
            "tender_publishing_date": self.parse_date(source_doc.get("publication_date")),
            "tender_organisation": "NATO Support and Procurement Agency (NSPA)",
            ...
            "llm_status": "pending",
            "source_tag": "NSPA-NATO",
            "source_id": self.source_website,
            "tender_city": None,
            "tender_state": None,
            "tender_country": source_doc.get("country")
        }
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        return {
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name": "NATO Support and Procurement Agency (NSPA)",
                "office_name": None
            },
            "timeline": {
                "bid_end_datetime": self.parse_date(source_doc.get("closing_date")),
                "bid_open_datetime": self.parse_date(source_doc.get("closing_date")),
