...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("Misd_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity = "City of Mansfield,Texas",
                 source_website= "https://www.mansfieldtexas.gov",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "mansfield_tx_tenders",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_pincode": None,
            "tender_purchaser_address": self.get_purchaser_address(source_doc), 
            ...
            "tender_organisation": "City of Mansfield Texas",
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name": "City of Mansfield Texas",
                "office_name": None
            },
            "timeline": {
