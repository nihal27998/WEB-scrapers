...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("delaware_tender_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity="States of Delaware",
                 source_website="https://mmp.delaware.gov/Bids/",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "delaware_mmp_tenders",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        subject = source_doc.get("quotation_subject", "")

        target_doc = {
            "teb_number": source_doc.get("teb_number"),
            "tender_number": source_doc.get("bid_id"),
            "tender_id": source_doc.get("quotation_number"),
            ...
            "tender_pincode": None,
            "tender_purchaser_address": source_doc.get("contact_email"),
            "tender_start_date": self.parse_date(source_doc.get("start_date")),
            "tender_end_date": self.parse_date(source_doc.get("end_date")),
            "tender_publishing_date": self.parse_date(source_doc.get("start_date")),
            "tender_organisation": "States of Delware",
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        return {
            "basic_info": {
                "generated_title": source_doc.get("quotation_subject"),
                "summary": source_doc.get("quotation_subject"),
                "tender_type": "OPEN",
                "main_category": None,
                "sub_category": None,
                "total_quantity": None,
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name": "States of Delaware",
                "office_name": None
            },
            "timeline": {
                "bid_end_datetime": self.parse_date(source_doc.get("end_date")),
                "bid_open_datetime": self.parse_date(source_doc.get("end_date")),
