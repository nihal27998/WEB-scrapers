...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("fci_tender_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity="County of San Diego",
                 source_website="https://sdbuynet.sandiegocounty.gov/",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "sd_buynet_tenders",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_number": source_doc.get("process_id"),
            "tender_id": source_doc.get("rfx_number"),
            ...
            "tender_start_date": self.parse_date(source_doc.get("begin_date_raw")),
            "tender_end_date": self.parse_date(source_doc.get("end_date_raw")),
            "tender_publishing_date": self.parse_date(source_doc.get("begin_date_raw")),
            "tender_organisation": "County of San Diego",
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        return {
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name": "County of San Diego",
                "office_name": None
            },
            "timeline": {
                "bid_end_datetime": self.parse_date(source_doc.get("end_date_raw")),
                "bid_open_datetime": self.parse_date(source_doc.get("end_date_raw")),
