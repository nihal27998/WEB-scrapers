...
class ETL:
    def __init__(self,
                 tender_issuing_entity = "University Hospital Brno",
                 source_website= "https://ezak.fnbrno.cz/contract_display_6710.html",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "ezak_fnbrno_tenders",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_organisation": "University Hospital Brno",
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "organization": {
                ...
                "organisation_name": "University Hospital Brno",
                "office_name": None
            },
            "timeline": {
