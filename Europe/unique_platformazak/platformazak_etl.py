...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("ezak_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity = "University of Warmia and Mazury in Olsztyn",
                 source_website= "https://platformazakupowa.pl/pn/umw.edu/",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "platformazakupowa_tenders",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_number": source_doc.get("proceeding_id"),  
            "tender_id": None,
            ...
            "tender_pincode": None,
            "tender_purchaser_address": "Poland",

            "tender_start_date": self.parse_date(source_doc.get("publication_date_raw")),
            "tender_end_date": self.parse_date(source_doc.get("opening_date_raw")),
            "tender_publishing_date":self.parse_date(source_doc.get("publication_date_raw")),                                                  \

            "tender_organisation":  source_doc.get("organization_name"),
            ...
            "source_tag": "platformazakupowa",
            "source_id": self.source_website,
            "tender_city": None,
            "tender_state": None,
            "tender_country": "Poland",
        }
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "organization": {
                "ministry": None,
                "department": source_doc.get("authority_department"),
                "organisation_name": source_doc.get("organization_name"),
                "office_name": None
            },
            "timeline": {
