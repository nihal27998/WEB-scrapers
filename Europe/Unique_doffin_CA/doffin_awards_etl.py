...
class TenderETL:
    ...
    def __init__(self,
        source_collection: str = "doffin_awards",
        source_website: str = "https://www.doffin.no/",
        db_name: str = "tender_bharo",
        target_collection_name: str = "main_tender_collection2"):
        ...
        logger.info(" DOFFIN CA ETL Initialized Successfully")
    ...
    def transform(self, raw_data):
        ...
        return {
            ...
            "tender_number":raw_data.get("notice_id"),
            "tender_id":None,
            ...
            "tender_state":None,
            "tender_pincode":None,
            "tender_country":"Norway",

            "tender_organisation":None,
            "tender_financier":"Self Financier",
            "tender_item_quantity":None,
            "tender_purchaser_ownership":"Public",
            "tender_value":raw_data.get("contract_value"),
            "tender_emd":None,
            "tender_document_fees":None,
            "tender_purchaser_address":raw_data.get("organizations"),

            "tender_start_date":self.parse_date(raw_data.get("issue_date")),
            "tender_end_date":None,
            "tender_publishing_date":self.parse_date(raw_data.get("issue_date")),
            ...
            "bid_awarded_result": {
                "bid_details": {
                    "bid_number":raw_data.get("notice_id"),
                    "status":"AWARDED",
                    "quantity":None,
                    "validity":None,
                    "start_date":self.parse_date(raw_data.get("issue_date")),
                    "end_date":None,
                    "opening_date":self.parse_date(raw_data.get("issue_date")),
                    "buyer_name":raw_data.get("buyer_name"),
                    "buyer_address":raw_data.get("organizations"),
                    "ministry":None,
                    "department":None,
                    "organisation":None,
                    "office":None
            ...
            "technical_evaluation": [
                {
                    "serial_no": None,
                    "seller_name": (raw_data.get("awarded_suppliers", [{}])[0].get("name")
    if raw_data.get("awarded_suppliers")
    else None
),
                    "offered_item":None,
    ...
    if raw_data.get("awarded_suppliers")
                        ...
                        "offered_item": None,
                        "participated_on": None,
                        "total_price": raw_data.get("contract_value"),
                        "rank": "L1",
                        "is_winner": "winner",
                        "status": "L1",
                        "currency": "NOK",
                        "seller_address":"NORWAY",
                        "seller_contact_number":"",
                        "seller_email_id":None,
                        "seller_country":"NORWAY",
            ...
            "llm_extracted_data": {
                ...
                "organization": {
                    "ministry": None,
                    "department": None,
                    "organisation_name":raw_data.get("buyer_name"),
                    "office_name": None
                },
                ...
                "financial": {
                    "estimated_bid_value": {
                        "amount": raw_data.get("contract_value"),
                        "currency": "NORWAY",
                        "raw_text": None
                    },
                    "emd_details": [
    ...
    def run(self):
        raw_collection = self.db["doffin_awards"]
        etl_collection = self.db["main_tender_collection2"]
