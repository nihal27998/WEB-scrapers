...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("klekkon_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity = "KLEKOON",
                 source_website= "https://www.klekoon.com/rechercher-une-annonce-ou-un-dce-dematerialise-sur-klekoon",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "klekoon_tenders",
                 target_collection_name: str = "main_tender_collection9"):
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_number": source_doc.get("tender_number"),  
            "tender_id": source_doc.get("tender_id"),  
            "tender_ra_number": None,
            "tender_title":   subject.lower().capitalize(),
            "tender_description": subject.lower().capitalize(),
            "tender_category": source_doc.get("category"),

            "tender_bidding_type": "International Competitive Bidding (ICB)",
            "tender_type": source_doc.get("bid_status"),
            ...
            "tender_pincode": None,
            "tender_purchaser_address":f"{source_doc.get('authority_address', '')}, {source_doc.get('authority_phone', '')}",

            "tender_start_date": self.parse_date(source_doc.get("publication_date")),
            "tender_end_date": self.parse_date(source_doc.get("deadline")),
            "tender_publishing_date":self.parse_date(source_doc.get("publication_date")),                                                  \

            "tender_organisation":source_doc.get("authority_name"),
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        ...
        category_doc = {
            ...
            "description": source_doc.get("title"),
        }
        ...
        return {
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name":source_doc.get("authority_name"),
                "office_name": None
            },
            "timeline": {
                "bid_end_datetime": self.parse_date(source_doc.get("deadline")),
                "bid_open_datetime": self.parse_date(source_doc.get("deadline")),
