...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("rib_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity = "RIB Software SE",
                 source_website= "https://www.doffin.no/search?page=1&type=ANNOUNCEMENT_OF_COMPETITION",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "rib_meinauftrag_tenders",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_category": (
    source_doc.get("cpv_items", [{}])[0].get("name")
    if source_doc.get("cpv_items")
    else None
),
            ...
            "tender_pincode": None,
            "tender_purchaser_address":"GERMANY",
            ...
            "tender_organisation":f"{source_doc.get('authority_name', '')}, {source_doc.get('authority_address', '')}",
            ...
            "source_tag": "RIB-ITWO-TENDER",
            "source_id": self.source_website,
            "tender_city": None,
            "tender_state": None,
            "tender_country": "GERMANY",
        }
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name":f"{source_doc.get('authority_name', '')}, {source_doc.get('authority_address', '')}",
                "office_name": None
            },
            "timeline": {
