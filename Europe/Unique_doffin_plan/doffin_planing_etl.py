...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("Doffin_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity = "The Norwegian Agency for Public and Financial Management (DFØ).",
                 source_website= "https://www.doffin.no/search?page=1&type=ANNOUNCEMENT_OF_COMPETITION",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "doffin_planning_tenders",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_number": source_doc.get("notice_id"),  
            "tender_id": None,
            ...
            "tender_pincode": None,
            "tender_purchaser_address": source_doc.get("organizations"),

            "tender_start_date": self.parse_date(source_doc.get("issue_date")),
            "tender_end_date": self.parse_date(source_doc.get("deadline")),
            "tender_publishing_date":self.parse_date(source_doc.get("issue_date")),                                                  \

            "tender_organisation":  source_doc.get("buyer_name"),
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "organization": {
                "ministry": None,
                "department": None,
                "organisation_name": source_doc.get("buyer_name"),
                "office_name": None
            },
            "timeline": {
