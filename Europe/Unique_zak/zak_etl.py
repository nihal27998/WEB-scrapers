...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("zak_processor.log"),
...
class ETL:
    def __init__(self,
                 tender_issuing_entity = "Masaryk University",
                 source_website= "https://zakazky.muni.cz/contract_index.html?type=all&state=all&archive=ALL&contract_place=&page=1",
                 db_name: str = "tender_bharo",
                 source_collection_name: str = "ezak_muni_tenders",
    ...
    def transform(self, source_doc: Dict[str, Any]) -> Dict[str, Any]:
        ...
        target_doc = {
            ...
            "tender_number": source_doc.get("system_number"),  
            "tender_id": source_doc.get("contract_id"),
            ...
            "tender_pincode": None,
            "tender_purchaser_address": source_doc.get("authority_address"),

            "tender_start_date": self.parse_date(source_doc.get("start_date_raw")),
            "tender_end_date": self.parse_date(source_doc.get("deadline_raw")),
            "tender_publishing_date":self.parse_date(source_doc.get("start_date_raw")),                                                  \

            "tender_organisation": "Masaryk University",
            ...
            "source_tag": " E-ZAK MUNI",
            "source_id": self.source_website,
            "tender_city": None,
            "tender_state": None,
            "tender_country": "Czech Republic",
        }
    ...
    def _build_llm_data(self, source_doc: Dict) -> Dict[str, Any]:
        ...
        return {
            ...
            "organization": {
                ...
                "organisation_name": "Masaryk University",
                "office_name": None
            },
            "timeline": {
